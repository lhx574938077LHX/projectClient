	 ...
	 private String host = ""; // smtp服务器
	    ...
	    public void send(String host, String user, String pwd) {
	        ...
	        try {
	            ...
	            // 向multipart对象中添加邮件的各 // 向multipart对象中添加邮件的各个部分内容，包括文本内容和附件
...
//	            DataSource source = (DataSource) new FileDataSource(affix);
	            // 添加附件的内容
...
//	            multipart.addBodyPart(messageBodyPart);
	    ...
	    public static void main(String[] args) {
	        ...
	        // 设置发件人地址、收件人地址和邮件标题
	        cn.setAddress("lihongxiang@91zhengxin.com", "330742137@qq.com", "一个带附件的JavaMail邮件");
	        // 设置要发送附件的位置和标题
	       // cn.setAffix("f:/123.txt", "123.txt");
	        ...
	        cn.send("smtp.ym.163.com", "lihongxiang@91zhengxin.com", "lhx854");
