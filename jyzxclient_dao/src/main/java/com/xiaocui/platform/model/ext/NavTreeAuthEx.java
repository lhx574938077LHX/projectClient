package com.xiaocui.platform.model.ext;

import java.util.List;


public class NavTreeAuthEx{
	 ...
	 * @createdate 创建日期 2015-10-13 10:23:10
	...
	private List<NavTreeAuthEx> children;
	
	public List<NavTreeAuthEx> getChildren() {
		return children;
	}

	public void setChildren(List<NavTreeAuthEx> children) {
